            ...
            <div class="table-responsive w-100">
                <div class="table-wrapper w-100">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8"><h2>Vuelos <b>Disponibles</b></h2></div>
                            <div class="col-sm-4">
                                <button href="{{ route('create') }}" type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</button>
                            </div>
                        </div>
                    </div>
                    <table class="table table-bordered ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$flight->price}}</td>
                                <td>
                                    <a href="{{ route('edit') }}" class="edit" title="Edit" data-toggle="tooltip"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                    ...
                                    <a href="{{ route('delete') }}" class="delete" title="Delete" data-toggle="tooltip"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19M8.46,11.88L9.87,10.47L12,12.59L14.12,10.47L15.53,11.88L13.41,14L15.53,16.12L14.12,17.53L12,15.41L9.88,17.53L8.47,16.12L10.59,14L8.46,11.88M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z" /></svg>
                                    </a>
                                    <a href="{{ route('buy') }}" class="buy" title="buy" data-toggle="tooltip"><svg style="width:24px;height:24px" viewBox="0 0 24 24">
